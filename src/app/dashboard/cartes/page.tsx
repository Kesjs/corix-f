    ...
    <div className="w-full max-w-md mx-auto">
      ...
      <div className="relative rounded-3xl overflow-hidden shadow-2xl bg-black aspect-[1.586/1] border border-white/10">
        ...
        <div className="absolute bottom-8 left-6">
          ...
          <p className="text-white font-medium tracking-wider">{holderName}</p>
        </div>
        ...
        {isVirtual && (
          <Badge className="absolute top-20 right-28 bg-white/10 text-white text-xs px-3 py-1">
            VIRTUELLE
          </Badge>
        )}
