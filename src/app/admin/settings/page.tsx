    ...
    <div className="min-h-screen bg-background">
      ...
      <aside className="fixed left-0 top-0 bottom-0 w-64 bg-white border-r border-border z-50">
        ...
        <nav className="p-4 space-y-1">
          ...
          <a href="/admin/reports" className="flex items-center gap-3 px-4 py-3 rounded-lg text-muted-foreground hover:bg-secondary hover:text-foreground transition-colors">
            <AlertCircle className="w-5 h-5" />
            <span className="font-medium">Rapports</span>
          </a>
          <a href="/admin/settings" className="flex items-center gap-3 px-4 py-3 rounded-lg bg-accent/10 text-accent">
