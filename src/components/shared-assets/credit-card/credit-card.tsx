...
const GLOW_TYPES = ["transparent", "transparent-gradient", "brand-dark", "gray-dark", "transparent-strip"] as const;
...
export const CreditCard = ({
    ...
    const showGlow = GLOW_TYPES.includes(type as (typeof GLOW_TYPES)[number]);
